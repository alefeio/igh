      ...
      {data ? (
        <>
          ...
          {data.alerts.length === 0 ? (
            ...
            <>
              <section>
                <h2 className="mb-3 text-lg font-bold">Exige decisão</h2>
                  ...
                  {data.alerts
                    ...
                    .map((a) => (
                      ...
                      >
                        ...
                        <p className="mt-2 text-xs text-[var(--text-muted)]">Origem: {a.source}</p>
              ...
              {data.alerts.some((a) => a.severity === "info") ? (
                <section className="mt-8">
                  ...
                  <ul className="space-y-3">
                    {data.alerts
                      .filter((a) => a.severity === "info")
                      .map((a) => (
                        <li key={a.id} className="rounded-xl border border-[var(--card-border)] bg-[var(--card-bg)] p-4">
                          <div className="flex flex-wrap items-center gap-2 text-xs uppercase tracking-wide text-[var(--text-muted)]">
                            <span>{severityLabel(a.severity)}</span>
                            <span>·</span>
                            <span>{domainLabel(a.domain)}</span>
