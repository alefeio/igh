...
export async function POST(request: Request) {
  ...
  if (await enqueueIfNeedsApproval(user, "site_news_category", "create", null, payload)) {
...
export async function PATCH(request: Request) {
  ...
  if (await enqueueIfNeedsApproval(user, "site_news_category", "update", null, { ids: parsed.data.ids }, previous)) {
