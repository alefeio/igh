  ...
  return (
    <div className="rounded-xl border border-[var(--igh-border)] bg-[var(--igh-surface)] p-4 text-sm text-[var(--igh-muted)]">
      <p>
        ...
        ideias ou responder, entre com sua conta de aluno, professor ou equipe {BRAND.shortName}.
      </p>
  ...
  return (
    <ToastProvider>
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-10">
        ...
        <h1 className="mt-2 text-3xl font-bold text-[var(--igh-secondary)] sm:text-4xl">{BRAND.communityName}</h1>
